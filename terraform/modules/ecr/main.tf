# ECR Module
# Creates a private container registry with lifecycle policy
...
# Lifecycle policy to limit the number of stored images
...
resource "aws_ecr_repository_policy" "main" {
  count      = var.allow_pull_from_accounts != null ? 1 : 0
  repository = aws_ecr_repository.main.name
